...
- `data_module/monthly_revenue_availability_history.py` / `scripts/build_monthly_revenue_availability_history.py`（Month 5 月營收公告日 historical dry-run builder；讀 TWSE/TPEX 官方 `出表日期` 或人工提供 JSON，輸出候選 mapping / diagnostics，不寫正式 mapping 或 SQLite）
