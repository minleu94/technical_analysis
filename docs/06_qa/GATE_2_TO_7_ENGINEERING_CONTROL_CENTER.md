...
|---|---|---|---|---|
| Development | `approved_weekly_history_3_of_3_projection_ready` | Dataset `terra-development-v0:terra-v0-canonical-2025-dev-20260714` 與 sanitized Research Console projection SHA-256 `06BED1ABF3222EA1CA35DF8A25EDB8950025FA2314B4493A1AAEFEB18CA3614E` 均未變；外部 `approved-weekly-history-projection.v1` 已依 owner=`archi` 核准的 Week 3 record `eor_8ad5022385454f96` 更新為 3 筆，SHA-256 `02EB67FF812C17F604C34F4EB30C1B87941596AF6AA9EBAFF6EC1D555B64B4D8`，且固定 `formal_credit_authorized=false` | V2.2 weekly history UI disclosure 已達 `3/3 ready`；本次沒有新的自然成熟 outcome、MOPS 季報 artifact、官方 probe evidence 或可接受的 Fubon PIT／coverage 證據；未重跑 P0 audit/probe、Phase 3C apply、來源連線或任何資料庫寫入 | weekly projection gap 已關閉；Formal clock 仍須新的 decision-time Rule-only artifact 與合格 source lineage，不得把 3/3 weekly history 換算為 Formal observed day 或 credit |
...
截至本次 **2026-07-27** projection refresh，owner=`archi` 已核准且保存第三週 weekly review `eor_8ad5022385454f96`（2026-07-20 至 2026-07-26）；外部 sanitized `approved-weekly-history-projection.v1` 現有 3 筆互異週期，V2.2 weekly history UI disclosure 為 `3/3 ready`。這只關閉 weekly projection freshness gap，projection 仍固定 `formal_credit_authorized=false`，不形成 observed day、holdout consumption、denominator 或 formal credit。Formal Week 2 的 append-only `formal-week-2-20260726-r1` why-not revision 不回頭改寫；週內唯一 decision-time artifact 仍是 2026-07-21 的 TEMP/shadow `DEFER` snapshot（`snapshot:2330:20260721:6bec1c3d03ebae5e`）。read-only preflight 驗證 owner decision、binding 與 snapshot 結構有效，但該 snapshot 的 typed lineage 引用 Fubon candidate，而 Fubon decision `decision:fubon.marketdata:20260721-r1` 維持 `deferred`、eligibility=`none`，故固定回報 `fubon_source_not_accepted_for_formal_clock`、`formal_readiness=false`、formal credit snapshot count=`0`。Fubon dossier canonical content hash `sha256:8275ef80b6a409d3da4f9372569246abe0d28cabc60d322634c5d9a639715a60` 與 serialized file SHA-256 `3b7b2e925ff2ae3a6b6952ea4c68fce9d39c4ff375d1cacc7cd54cee58da8882` 均未變；既有 sidecar 仍只有 1 筆 shadow snapshot、0 筆 outcome revision。本次未建立 snapshot、未宣稱 holdout consumption、未重跑 P0/Phase 3C、未寫入任何 DB；2026 年 7 月尚未自然結束，故未新增月度 Gate Review。
