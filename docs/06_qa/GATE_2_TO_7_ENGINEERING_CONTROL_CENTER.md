...
|---|---|---|---|---|
| Development | `development_observed_degraded` | Dataset `terra-development-v0:terra-v0-canonical-2025-dev-20260714`；Research run `sha256:36e57e0c370ce0f08eb625de0871ffa49699bfdb469272f4c5d7bacaf8d910c5`；projection SHA-256 `06BED1ABF3222EA1CA35DF8A25EDB8950025FA2314B4493A1AAEFEB18CA3614E`；DEV-26 TWSE disposition candidate parser/probe | fit rows=`179271`；evaluation rows=`0`；OOF samples=`53559`；quarantine record 即使 direct construction 仍強制 identity/reason 與 raw row SHA-256；13 項中已有 4 項 candidate adapter，但 TWSE disposition 缺官方發布 timestamp，維持 research-only degraded；不是 source acceptance、formal OOS／promotion／投資有效性證據 | 僅在明確 apply 的既有 development working-copy DB 寫入；本 automation 未執行 apply；2026 matured outcomes 僅 evaluation，不得 fit |
