...
|---|---|---|---|---|
| Development | `development_observed_degraded` | Dataset `terra-development-v0:terra-v0-canonical-2025-dev-20260714`；DEV-35 富邦 P0 research adapter；DEV-36 bounded official P0 audit（2026-07-17 lineage `sha256:bada48c61987cc45f0b3eadb19d71f4dba2e9111fefa7dbe07c30c1fed732842`）；DEV-39 富邦 TEMP capture（2026-07-19，limit lock=`observed_research_only`） | 最近交易日 probe 以 43 秒完成：11 類官方 source 產生 observed candidate，共 86,482 accepted rows；limit lock 已由富邦唯讀 TEMP capture 補為 `observed_research_only`，但不是官方公告或 formal evidence；quarterly PIT 仍尚待可追溯 MOPS artifact；全部仍為 `degraded`／first-observed only，未寫入 DB | 僅供人工、唯讀 probe；不得呼叫帳務、委託或交易 API；2026 matured outcomes 僅 evaluation，不得 fit |
