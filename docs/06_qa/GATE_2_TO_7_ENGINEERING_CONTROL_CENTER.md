...
|---|---|---|---|---|
| Development | `development_observed_degraded` | Dataset `terra-development-v0:terra-v0-canonical-2025-dev-20260714`；Research run `sha256:36e57e0c370ce0f08eb625de0871ffa49699bfdb469272f4c5d7bacaf8d910c5`；DEV-35 富邦 P0 research adapter（disposition／periodic auction／halt／limit lock／dividend／capital changes） | fit rows=`179271`；evaluation rows=`0`；OOF samples=`53559`；富邦 adapter 僅輸出 `degraded`、`first_observed_only`、research-only TEMP projection；全額交割、月營收、季報 PIT、法人、信用、TDCC 仍需官方 source；本次未實際登入或寫入 DB | 僅供人工、唯讀 probe；不得呼叫帳務、委託或交易 API；2026 matured outcomes 僅 evaluation，不得 fit |
