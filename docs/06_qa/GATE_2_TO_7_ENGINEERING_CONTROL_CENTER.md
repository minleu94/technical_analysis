...
|---|---|---|---|---|
| Development | `development_observed_degraded` | Dataset `terra-development-v0:terra-v0-canonical-2025-dev-20260714`；Research run `sha256:36e57e0c370ce0f08eb625de0871ffa49699bfdb469272f4c5d7bacaf8d910c5`；projection SHA-256 `06BED1ABF3222EA1CA35DF8A25EDB8950025FA2314B4493A1AAEFEB18CA3614E`；DEV-34 Fubon manual market-data probe boundary tests | fit rows=`179271`；evaluation rows=`0`；OOF samples=`53559`；富邦 probe 只允許登入後呼叫 OTC 行情 snapshot，缺 credential 或登入失敗即停止；本次未實際登入或發網路請求；不是 source acceptance、formal OOS／promotion／投資有效性證據 | 僅供人工、唯讀連線診斷；不得呼叫帳務、委託或交易 API；2026 matured outcomes 僅 evaluation，不得 fit |
