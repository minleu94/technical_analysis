...
|---|---|---|---|---|
| Development | `DEV-108-formal-lane-observed-snapshot-custody-audit-20260805` | 新 owner lane decision `formal-rule-only-20260805-r1` 與 v3 registry binding 均唯讀驗證有效：first eligible session=`2026-08-05`、lane content hash=`sha256:e29b7a1ec3d6bea91740f5cd5818634f3dbf32efefd14fcf7a2b33c7fb35b665`、registry SHA=`sha256:02c03c766d5c533efa35886f7fd7f556dd9f4a3c3ba4ded326092803b21dbf70`；readiness no-snapshot=`sha256:8366d828a62930b1f967fc0b007473157da87f09bb41e315d7d19eae8095b5d0`，historical 2026-07-29 snapshot=`sha256:d390f1c1d40f8fbdb925e80fd08168de960e6751b62e023a7fbb1e4519915d1f`；TEMP audit result=`sha256:e43b1d9516d66762126f6b0d75d00a3409084de0a23badc41c9510441e5949ae`、manifest=`sha256:9e18a339ee03c1e617b4136d35f802c9a41c4d3262f9ca95d922f97d50d65b1b`、self-check=`sha256:b2fb4d8c940eb7f225b6a0e016a4fca2bf1e7e39920a81b705c3bd3aea098c96`；`checks=18`、validation PASS | current-session snapshot missing；historical snapshot invalid because decision-output lineage lacks hash-addressed parent；兩者均不得轉成 observed day／Formal credit | 全部仍為 TEMP research-only；未建立 snapshot、未寫 registry、未寫正式 DB、未 training／promotion／unblind／blend、GPU 不在 scope。下一個合格 increment 只能核對新的 genuine current-session `manual_observed` artifact；不得歷史回填、replay、fixture 或以 invocation count 合成 credit |
