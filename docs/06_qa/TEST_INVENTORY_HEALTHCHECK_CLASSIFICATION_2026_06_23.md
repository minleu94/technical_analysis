...
2026-08-28 全量 pytest 已以 `-o addopts=` 完成：`3665 passed, 1 skipped, 26 warnings`（`558.10s`；freshness probe ACL fail-soft、freshness readiness projection、Evidence Workbench pending-period、formal cutoff 診斷與 PowerShell wrapper canonical delegation 納入後的完整回歸）。
