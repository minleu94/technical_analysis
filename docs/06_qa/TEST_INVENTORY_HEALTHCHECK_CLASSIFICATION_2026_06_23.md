...
2026-08-28 全量 pytest 已以 `-o addopts=` 完成：`3606 passed, 1 skipped, 26 warnings`
（`516.22s`；未指定 JUnit 輸出）。下方較早的 `3603 passed`／`3592 passed` 是前一輪中間基準，
不取代本次完整回歸結果。
