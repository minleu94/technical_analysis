...
2026-08-05 以 Owner 授權的 bounded research acquisition 取得 7 個新的 MOPS 2025-Q1 immutable numeric／publication candidates；連同既有 4 個候選共 11 個 identity，聚合後為 506 個 PIT-eligible rows、28 bp coverage（canonical denominator 179,271，距固定 8,000 bp 門檻 7,972 bp）。這些 artifacts 全部留在 TEMP research root，未寫正式 SQLite、未 materialize、未進 fit/training，也不構成 source acceptance。
