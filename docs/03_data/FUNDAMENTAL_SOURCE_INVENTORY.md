...
2026-08-05 以 Owner 授權的 bounded research acquisition 再取得 7 個新的 MOPS 2025-Q1 immutable numeric／publication candidates；連同既有候選共 18 個 identity，聚合後為 820 個 PIT-eligible rows、45 bp coverage（canonical denominator 179,271，距固定 8,000 bp 門檻 7,955 bp）。本批 1109、1110、1213 因 `doc.twse.com.tw` DNS failure fail-closed，未補值或重試成形式資料。這些 artifacts 全部留在 TEMP research root，未寫正式 SQLite、未 materialize、未進 fit/training，也不構成 source acceptance。
