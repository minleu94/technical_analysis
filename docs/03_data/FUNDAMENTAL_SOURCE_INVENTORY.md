...
2026-08-05 以 Owner 授權的 bounded research acquisition 再取得 7 個新的 MOPS 2025-Q1 immutable numeric／publication candidates；連同既有候選共 25 個 identity，聚合後為 1,140 個 PIT-eligible rows、63 bp coverage（canonical denominator 179,271，距固定 8,000 bp 門檻 7,937 bp）。本批 1303、1310、1314 的 foreground runner 在輸出細項 diagnostics 前逾時，三者未產生 immutable bundle；後續對受治理 MOPS EZSearch availability sidecar 的 F26–F29 查詢也全部 `invalid_response`、0 events／0 projections，未猜測原因、未補值或重試成形式資料。這些 artifacts 全部留在 TEMP research root，未寫正式 SQLite、未 materialize、未進 fit/training，也不構成 source acceptance。
