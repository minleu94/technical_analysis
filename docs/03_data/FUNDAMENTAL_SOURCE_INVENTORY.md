...
2026-08-05 以 Owner 授權的 bounded research acquisition 已取得 29 個新的 MOPS 2025-Q1 immutable numeric／publication candidates（DEV-82 的 7 個、DEV-84 的 1215、DEV-85 的 5 個、DEV-86 的 4 個、DEV-87 的 5 個、DEV-88 的 3 個、DEV-89 的 4 個）；DEV-90 另嘗試 1409、1410、1413、1414、1416 五個 identity，0/5 取得 candidate bundle；連同既有候選仍為 47 個 identity，聚合後為 1,987 個 PIT-eligible rows、110 bp coverage（canonical denominator 179,271，距固定 8,000 bp 門檻 7,890 bp）。DEV-84 的 1217、1218、1219、1220、DEV-86 的 1256、DEV-88 的 1326、1337、DEV-89 的 1342、DEV-90 的 1409、1410、1413、1414、1416 均因 timeout／DNS／listing contract diagnostics fail-closed；DEV-85 五個、DEV-86 四個、DEV-87 五個、DEV-88 三個、DEV-89 四個新身份取得成功；DEV-83 的 EZSearch F26–F29 仍全部 `invalid_response`、0 events／0 projections。未猜測原因、未補值或重試成形式資料；所有 artifacts 留在 TEMP research root，未寫正式 SQLite、未 materialize、未進 fit/training，也不構成 source acceptance。
