...
DEV-104 以 query-only／immutable SQLite 做 source-freshness diagnostic：current `twstock.db` SHA=`sha256:31f4ca4b8789805239884da22a6a36cbebf482d0726fcdcbc6f52e1842113414`，不同於 raw publication `pit-413ff34c1d2c6cc9fdaa2849` recorded fingerprint=`sha256:23ad4fb019ac76d1eca0ea36a6b33e4d7719e7530a9bab1187d565a332480665`；size 相同但 DB mtime 晚 341.041629 秒。以相同 11 symbols／2024–2026 scope 查詢，11 個 table 的 bounded source row counts 與 raw manifest 全部一致，然而 value equivalence 未證明，既有 publication 不得直接組裝或訓練。TEMP result SHA=`sha256:45cda32d7dd9a2705ff8b80beed685683d5d196dc3cd4ba01a7e38305989c004`、manifest SHA=`sha256:925e48f6855baf3dba01e5c99331bbc85eb178c850fcf750175a14f059cd051e`、self-check SHA=`sha256:f9dee8ed46187799f61ac484c30fd21d2708f54b304866c3787e12562b021090`；此為 source-freshness blocker，不是 numeric backfill、source acceptance 或 formal evidence。
