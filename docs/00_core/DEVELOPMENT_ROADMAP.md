...
V1 release 後的版本化交付節奏見 [VERSION_ROADMAP_V1_1_TO_V2_0.md](VERSION_ROADMAP_V1_1_TO_V2_0.md)：V1.1、V1.2、V1.3、V1.4、V1.5、V1.6、V1.7、V1.8、V1.9 v1、V2.0 Phase 1 read-only prototype slice、Workbench formal read-only source adapter 與 Phase 2 Workbench MVP shell / background evidence feed / read-only Action Items MVP 已完成；下一步不是啟用 production scheduler，也不是把 replay 當成 gate，而是繼續累積 Phase 0 weekly / multi-day evidence，並把 Workbench 從目前的 feed / Action Items MVP 推進到完整 operating loop。部分 Post-V1 design / QA 檔名保留後續里程碑日期，不作為 Roadmap Hub 的完成日期權威。
