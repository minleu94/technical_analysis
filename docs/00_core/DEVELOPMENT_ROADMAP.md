...
6. **P1：V2.0 前置補強**
   ...
   - 2026-07-06 Phase 0A replay quality audit 已完成，benchmark 全缺已解除；下一個可立即推進的 2.0 任務是 V2.0 Phase 1 read-only Workbench design spike，使用 `_reference_fix` replay summary 顯示 source gap、payload gap、event family、outcome maturity 與 quality boundary，不顯示成策略績效結論。
