...
- **進行中 / 當前治理**：fixed / quantile 實證 Gate 已通過；quantile 未優於 fixed 並維持 opt-in。Research Run Registry M2-B 基礎保存、M2-C Comparability Service 與 Registry 比較子頁已完成，後續進入 Registry-based Promote Gate。
