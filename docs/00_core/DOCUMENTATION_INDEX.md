...
- 2026-07-03：新增 Decision Desk working-copy smoke follow-up QA 索引，標示 batch snapshot service-backed builder 修補後 risk-prompt evidence 可在 working-copy confirm smoke 中保存且 idempotency passed；production scheduler 仍未啟用。
