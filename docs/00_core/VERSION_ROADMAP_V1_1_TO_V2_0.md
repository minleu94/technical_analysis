...
11. V1.8 / V1.9 sandbox batch：portfolio construction sandbox 與 virtual execution trace 已完成 v1；read-only MCP / Agent evidence access 留待 V1.9。
