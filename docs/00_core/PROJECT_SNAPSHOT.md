...
2. 每日先看 `決策工作台` 的中文優先 status strip、今日待判讀、背景證據流、只讀 Action Items、Evidence mode / data quality、Daily Checklist 與 warnings；需要細節時用 Workbench 的 read-only drill-down 切到 Daily Decision Desk、Evidence Review 或 Portfolio，或再進 Market Watch / Smart Money。
