...
- 2026-08-29 CLI guard 後的 deterministic inventory 為 `662/662` 個測試檔、`3,820 collected`，machine-checkable blocker=`0`；Paper daily／Stress history／月營收 merge 相關定向測試共 `19 passed`，尚未以此小修正宣稱完整 pytest 重跑或任何正式 gate 通過。
