...
- 結果保存已接入 Research Run Registry；Research Lab 內新增 Registry 比較子頁，可篩選、分頁、多選 2 至 5 個 run，顯示 comparability、參數差異、normalized equity、metrics、Regime 與保存 benchmark。Registry-based Promote Gate 已接入 service 層，策略版本 JSON 與 Registry 回填具補償與 reconciliation 防線。
