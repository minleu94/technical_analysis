...
> 這是台股技術分析系統的測試文檔，包含測試環境設置、測試數據、測試模塊和測試報告等詳細信息。
> 此文檔應配合以下文檔一起閱讀：
> - [README.md](README.md) - 系統概述和快速開始
> - [readme.txt](readme.txt) - 完整的系統功能說明
> - [docs/system_architecture.md](docs/system_architecture.md) - 系統架構文檔
> - [docs/note.txt](docs/note.txt) - 開發進度記錄
> - [docs/tests_readme.md](docs/tests_readme.md) - tests/ 目錄結構說明
