...
from data_module.data_source_capability_registry import inspect_data_source_capabilities


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Inspect V1.5 data source capabilities.")
