"""
暴衝策略執行器 (Momentum Aggressive Strategy)
適用於趨勢市場，追求高報酬，風險較高
"""
...
class MomentumAggressiveExecutor(StrategyExecutor):
    """
    暴衝策略（Momentum Aggressive）
    
    策略理念（Why）：
    - 在強勢趨勢市場中，追隨動能，追求快速獲利
    - 適合風險承受度高的投資者
    - 在趨勢明確時進場，趨勢轉弱時快速出場
    ...
    def get_meta():
        ...
        return StrategyMeta(
            ...
            name='暴衝策略',
            description='在強勢趨勢市場中追隨動能，追求快速獲利。適合風險承受度高的投資者。',
            regime=['Trend', 'Breakout'],
            not_suitable_regime=['Reversion'],
            risk_level='high',
    ...
    def __init__(self, spec: StrategySpec):
        ...
        self.buy_score = params.get('buy_score', 70)
        self.sell_score = params.get('sell_score', 50)
