...
class EvidenceEventType(str, Enum):
    ...
    SCREENING_MATRIX_PASS = "screening_matrix_pass"
    SCREENING_MATRIX_FAIL = "screening_matrix_fail"
    SCREENING_MATRIX_DEGRADED = "screening_matrix_degraded"
    SCREENING_MATRIX_SKIPPED = "screening_matrix_skipped"
    SCREENING_MATRIX_MISSING = "screening_matrix_missing"
