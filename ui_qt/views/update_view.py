...
class UpdateView(QWidget):
    ...
    def _timeline_status_color(value: Any) -> str:
        return {
            ...
            "degraded": "#fbbf24",
            "stale": "#fbbf24",
            "candidate_available": "#fbbf24",
            "waiting_for_external_input": "#fbbf24",
            "waiting_for_formal_inputs": "#fbbf24",
            "action_required": "#fbbf24",
            "official_no_data": "#fbbf24",
            "no_data": "#fbbf24",
            "no_data_skipped_dates": "#fbbf24",
            "date_mismatch": "#fbbf24",
            "not_computable": "#fbbf24",
            "not_computable_cost_ledger_missing": "#fbbf24",
            "pending_human_review": "#fbbf24",
            "summary": "#fbbf24",
            "ready": "#86efac",
            "attention": "#fbbf24",
            "guarded": "#fbbf24",
            ...
            "failure": "#fca5a5",
            "error": "#fca5a5",
            "network_error": "#fca5a5",
            "transport_error": "#fca5a5",
            "registry_error": "#fca5a5",
            "schema_mismatch": "#fca5a5",
            "blocked_provenance": "#fca5a5",
            "blocked_insufficient_storage": "#fca5a5",
            "blocked": "#fca5a5",
            "missing": "#fca5a5",
            "invalid": "#fca5a5",
