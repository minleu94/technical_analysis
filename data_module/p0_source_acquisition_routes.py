...
_ROUTES = (
    ...
    _route("institutional_flows", "tpex.tpex_3insti_daily_trading", "TPEx", "otc", "https://www.tpex.org.tw/openapi/v1/tpex_3insti_daily_trading", license_evidence_url=TPEX_TERMS_URL, implementation_status="implemented_live_fallback", evidence_role="daily_flow"),
    ...
    _route("credit_transactions", "tpex.tpex_mainboard_margin_balance", "TPEx", "otc", "https://www.tpex.org.tw/openapi/v1/tpex_mainboard_margin_balance", license_evidence_url=TPEX_TERMS_URL, implementation_status="implemented_live_fallback", evidence_role="daily_credit_balance"),
