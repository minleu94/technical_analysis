...
def build_existing_suite_registry() -> tuple[ExistingSuite, ...]:
    registry = (
        ...
        ExistingSuite(
            ...
            modes=(HealthcheckMode.FULL,),
            command=(PYTHON, "-m", "pytest", "tests/test_ui_qt_recommendation_next_steps_copy.py", "-q", "-o", "addopts="),
            non_destructive=True,
            path="tests/test_ui_qt_recommendation_next_steps_copy.py",
        ...
        ExistingSuite(
            ...
            modes=(HealthcheckMode.FULL,),
            command=(PYTHON, "-m", "pytest", "tests/test_ui_qt_watchlist_candidate_pool_copy.py", "-q", "-o", "addopts="),
            non_destructive=True,
            path="tests/test_ui_qt_watchlist_candidate_pool_copy.py",
