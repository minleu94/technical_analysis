...
TEST_INVENTORY: dict[str, str] = {
    ...
    "tests/test_ui_qt_recommendation_next_steps_copy.py": "ui-healthcheck-direct-bridge",
    ...
    "tests/test_ui_qt_watchlist_candidate_pool_copy.py": "ui-healthcheck-direct-bridge",
