# Antigravity Rule 00 - Project Entry
...
若任務涉及 UI 操作流程、使用者參數、結果判讀或安全限制，再讀：

- `docs/07_guides/APPLICATION_MANUAL.md`

## 專案定位

本專案不是單純每日吐股票名單的工具，而是可驗證、可回溯、可演化的投資決策系統。
...
- Phase 5 研究輸出：Research Run Registry 與跨 run 比較能力

## 語言

所有回覆、文檔、程式碼註解均使用繁體中文。
