...
@pytest.mark.parametrize(
    ("available_date", "expected_diagnostic"),
    ((None, "missing_available_date"), ("not-an-iso-date", "invalid_available_date")),
)
def test_missing_or_invalid_observation_available_date_fails_closed(
    available_date: str | None, expected_diagnostic: str
) -> None:
    observation = P0ShadowObservation(
        source_id="institutional_flows",
        symbol="2330",
        decision_date="2026-07-12",
